...
const SvgPythonCompiled = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={16} height={16} {...props}>
    <g fill="none" strokeLinecap="round" strokeLinejoin="round">
      ...
      />
      <path stroke="#cdd6f4" d="M2.98 10.5H4.5c0-1.5 0-2 1-2h2m0-5" />
      <path stroke="#7f849c" d="M8.5 12.5" />
    </g>
  </svg>
);
export default SvgPythonCompiled;
